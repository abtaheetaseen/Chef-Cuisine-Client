...
const Footer = () => {
  return (
    ...
    <hr className="h-px my-6 bg-gray-200 border-none dark:bg-gray-700" />
        <div className="lg:flex">
            <div className="w-full -mx-6 lg:w-2/5">
                <div className="px-6">
                    ...
                    <p className="max-w-sm mt-2 text-gray-500 dark:text-gray-400">A restaurant is a place where you go to celebrate a special occasion, or to create a new one.</p>
        ...
        <div>
            <p className="text-center text-gray-500 dark:text-gray-400">© Chef-Cuisine 2020 - All rights reserved</p>
        </div>
    </div>
</footer>
  )
